...
export default {
  content: [
    ...
    "./node_modules/@heroui/theme/dist/components/(button|dropdown|form|input|link|navbar|pagination|spinner|table|ripple|menu|divider|popover|checkbox|spacer).js"
  ],
  theme: {
    extend: {
      colors:{
